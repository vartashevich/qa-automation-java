...
public class OrderedDistinctedMessageService extends ValidatedService implements MessageService {
     ...
     * Делегирует выполнение методу репозитория.
     *
    ...
    /**
     * Метод поиска записи по уровню важности. Если сообщения с такой важностью нет, то вернем пустую коллекцию.
     * Делегирует выполнение методу репозитория.
     *
     * @param by уровень важности сообщения
     * @return возвращает коллекцию записей, соответствующую уровню важности
     */
